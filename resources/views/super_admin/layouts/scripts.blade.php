		<!-- Libs JS -->
		<script src="{{ asset('admin/demo') }}/dist/libs/apexcharts/dist/apexcharts.min.js"></script>
		<script src="{{ asset('admin/demo') }}/dist/libs/jsvectormap/dist/js/jsvectormap.min.js"></script>
		<script src="{{ asset('admin/demo') }}/dist/libs/jsvectormap/dist/maps/world.js"></script>
		<!-- Tabler Core -->
		<script src="{{ asset('admin/demo') }}/dist/js/tabler.min.js"></script>
		<script src="{{ asset('admin/demo') }}/dist/js/demo.min.js"></script>
		<script>
			// @formatter:off
